...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Dez-2020 às 03:57
...
CREATE TABLE `custos_variaveis` (
  `id_custosvariaveis` int(11) NOT NULL,
...
ALTER TABLE `custos_variaveis`
  ADD PRIMARY KEY (`id_custosvariaveis`);
...
--
ALTER TABLE `custos_variaveis`
  MODIFY `id_custosvariaveis` int(11) NOT NULL AUTO_INCREMENT;
