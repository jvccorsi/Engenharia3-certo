...
=======
<<<<<<<< HEAD:pagina_usu.php
include('verify_login.php'); //php PARA VERFICIAR SE O USUÁRIO ESTÁ LOGADO!!
...
echo"<br>";
echo "<a href='sair.php'> Clique aqui para Sair </a>"; //NÃO TIRAR ISSO DA PAGINA!!
?>
========
...
>>>>>>>> parent of e43bd3e... Features: Separei o projeto por pastas e criei o config.php:Views/pagina_usu.php
