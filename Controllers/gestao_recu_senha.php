              ...
              <tr>
                <td class='wrapper'>
                  <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                      <tr>
                          <center>
                      <img src='https://i.postimg.cc/MMpNG5YX/logo-1.png' border='0' alt='logo-1'/>
                    </center>
                        </tr>
                    ...
                    <tr>
                      <td>
                        <p>Ola, tudo bem?</p>
                        <p>Você solicitou uma alteração de senha em nosso portal <b>Rolê de Rep</b>!! <br> Para alterar sua senha clique no botão abaixo:</p>
                        <table role='presentation' border='0' cellpadding='0' cellspacing='0' class='btn btn-primary'>
                          <tbody>
                            <tr>
                              <td align='left'>
                                <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                                  <tbody>
                                    <tr>
                                      <td> <a href='".$chave_acesso."' target='_blank'>Clique aqui </a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                            ...
                            <p>Ou copie e cole no seu navegador este link: ".$chave_acesso."</p>
                            <p>Atenciosamente, Equipe Rolê de Rep! </p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td class='content-block'>
                    <span class='apple-link'>© 2020 - Todos os Direitos Reservados - Rolê de Rep</span>
                  </td>
                </tr>
              </table>
            </div>
