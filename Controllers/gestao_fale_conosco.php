...
$obj_Fale_Conosco->queryInsert($_POST);
  ...
  $tipo_msg_contato_usu = $_POST['tipo_msg'];
  $descricao_usu = $_POST['descricao_usu'];
              ...
              <tr>
                <td class='wrapper'>
                  <table role='presentation' border='0' cellpadding='0' cellspacing='0'>
                    ...
                    <tr>
                      <td>
                        <p>Nome do usuário:<b> ".$nome_usu."</b></p>
                        <p>Email usuário: ".$email_usu."</p>
                        <p>Telefone para contato: ".$tel_contato_usu."</p>
                        <p>Tipo de mensagem : ".$tipo_msg_contato_usu."</p>
                        <p>Descrição da mensagem : ".$descricao_usu."</p>
                      </td>
                    </tr>
                  </table>
                </td>
